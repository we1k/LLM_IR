...
pdf2htmlEX --embed cfijo -f $START_PAGE --dest-dir pdf_output $INPUT_PDF_PATH > /dev/null
...
python3 query_qw_flash_attn.py --temperature 0.7 --top_p $TOP_P --seed 1203 --use-14B --output chatglm 
python3 query_qw_flash_attn.py --temperature $TEMPERATURE --top_p $TOP_P --seed $SEED --output baichuan --beam_search --best_of 3 --length_penalty 1.0 
